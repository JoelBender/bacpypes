...
class State:
    ...
    def enter_state(self):
        ...
        if self.timeout_transition:
            ...
            self.state_machine.state_timeout_task.install_task(_time() + self.timeout_transition.timeout)
        else:
...
class StateMachine:
    ...
    def run(self):
        ...
        if self.timeout_task:
            ...
            self.timeout_task.install_task(_time() + self.timeout)
    ...
    def before_send(self, pdu):
        ...
        self.transaction_log.append((_time(), "<<<", pdu),)
