...
"""
Nose Test Objects ScheduleObject
---------------------
"""
...
from bacpypes.object import ScheduleObject, WritableProperty, ReadableProperty, OptionalProperty, EventLogRecord
...
@bacpypes_debugging
class Test_ScheduleObject(unittest.TestCase, TestObjectHelper):
    """
    ...
    """
    def setUp(self):
        if _debug: Test_ScheduleObject._debug("Test_ScheduleObject")
        self.obj = ScheduleObject()
        self.objType = 'schedule'
