...
"""
Nose Test Objects MultiStateOutputObject
---------------------
"""
...
from bacpypes.object import MultiStateOutputObject, WritableProperty, ReadableProperty, OptionalProperty, EventLogRecord
...
@bacpypes_debugging
class Test_MultiStateOutputObject(unittest.TestCase, TestObjectHelper):
    """
    ...
    """
    def setUp(self):
        if _debug: Test_MultiStateOutputObject._debug("Test_MultiStateOutputObject")
        self.obj = MultiStateOutputObject()
        self.objType = 'multiStateOutput'
