...
from bacpypes.object import AccessPointObject, WritableProperty, ReadableProperty, OptionalProperty
...
@bacpypes_debugging
class Test_AccessPointObject(unittest.TestCase, TestObjectHelper):
    """
