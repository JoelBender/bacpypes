...
"""
Nose Test Objects MultiStateValueObject
---------------------
"""
...
from bacpypes.object import MultiStateValueObject, WritableProperty, ReadableProperty, OptionalProperty, EventLogRecord
...
@bacpypes_debugging
class Test_MultiStateValueObject(unittest.TestCase, TestObjectHelper):
    """
    ...
    """
    def setUp(self):
        if _debug: Test_MultiStateValueObject._debug("Test_MultiStateValueObject")
        self.obj = MultiStateValueObject()
        self.objType = 'multiStateValue'
