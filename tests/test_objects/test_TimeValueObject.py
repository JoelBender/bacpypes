...
"""
Nose Test Objects TimeValueObject
---------------------
"""
...
from bacpypes.object import TimeValueObject, WritableProperty, ReadableProperty, OptionalProperty, EventLogRecord
...
@bacpypes_debugging
class Test_TimeValueObject(unittest.TestCase, TestObjectHelper):
    """
    ...
    """
    def setUp(self):
        if _debug: Test_TimeValueObject._debug("Test_TimeValueObject")
        self.obj = TimeValueObject()
        self.objType = 'timeValue'
