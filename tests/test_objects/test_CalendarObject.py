...
"""
Nose Test Objects CalendarObject
---------------------
"""
...
from bacpypes.object import CalendarObject, WritableProperty, ReadableProperty, OptionalProperty
...
@bacpypes_debugging
class Test_CalendarObject(unittest.TestCase, TestObjectHelper):
    """
