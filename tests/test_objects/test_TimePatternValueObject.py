...
"""
Nose Test Objects TimePatternValueObject
---------------------
"""
...
from bacpypes.object import TimePatternValueObject, WritableProperty, ReadableProperty, OptionalProperty, EventLogRecord
...
@bacpypes_debugging
class Test_TimePatternValueObject(unittest.TestCase, TestObjectHelper):
    """
    ...
    """
    def setUp(self):
        if _debug: Test_TimePatternValueObject._debug("Test_TimePatternValueObject")
        self.obj = TimePatternValueObject()
        self.objType = 'timePatternValue'
