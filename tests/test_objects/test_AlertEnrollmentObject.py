...
"""
Nose Test Objects AlertEnrollmentObject
---------------------
"""
...
from bacpypes.object import AlertEnrollmentObject, WritableProperty, ReadableProperty, OptionalProperty
...
@bacpypes_debugging
class Test_AlertEnrollmentObject(unittest.TestCase, TestObjectHelper):
    """
