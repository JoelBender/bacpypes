...
"""
Nose Test Objects TrendLogObject
---------------------
"""
...
from bacpypes.object import TrendLogObject, WritableProperty, ReadableProperty, OptionalProperty, EventLogRecord
...
@bacpypes_debugging
class Test_TrendLogObject(unittest.TestCase, TestObjectHelper):
    """
    ...
    """
    def setUp(self):
        if _debug: Test_TrendLogObject._debug("Test_TrendLogObject")
        self.obj = TrendLogObject()
        self.objType = 'trendLog'
        self.identifiers = self.build_list_of_identifiers(self.obj.properties)
        self.numberOfPropertiesRequired = 36
        self.writeValue = 0
