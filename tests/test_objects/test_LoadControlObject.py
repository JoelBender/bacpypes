...
"""
Nose Test Objects LoadControlObject
---------------------
"""
...
from bacpypes.object import LoadControlObject, WritableProperty, ReadableProperty, OptionalProperty, EventLogRecord
...
@bacpypes_debugging
class Test_LoadControlObject(unittest.TestCase, TestObjectHelper):
    """
    ...
    """
    def setUp(self):
        if _debug: Test_LoadControlObject._debug("Test_LoadControlObject")
        self.obj = LoadControlObject()
        self.objType = 'loadControl'
