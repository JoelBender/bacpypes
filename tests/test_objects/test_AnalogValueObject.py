...
"""
Nose Test Objects AnalogValueObject
---------------------
"""
...
from bacpypes.object import AnalogValueObject, WritableProperty, ReadableProperty, OptionalProperty
...
@bacpypes_debugging
class Test_AnalogValueObject(unittest.TestCase, TestObjectHelper):
    """
    ...
    """
    def setUp(self):
        if _debug: Test_AnalogValueObject._debug("Test_AnalogValueObject")
        self.obj = AnalogValueObject()
        self.objType = 'analogValue'
