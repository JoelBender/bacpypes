...
"""
Nose Test Objects AveragingObject
---------------------
"""
...
from bacpypes.object import AveragingObject, WritableProperty, ReadableProperty, OptionalProperty
...
@bacpypes_debugging
class Test_AveragingObject(unittest.TestCase, TestObjectHelper):
    """
    ...
    """
    def setUp(self):
        if _debug: Test_AveragingObject._debug("Test_AveragingObject")
        self.obj = AveragingObject()
        self.objType = 'averaging'
