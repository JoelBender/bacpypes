...
"""
Nose Test Objects DateValueObject
---------------------
"""
...
from bacpypes.object import DateValueObject, WritableProperty, ReadableProperty, OptionalProperty
...
@bacpypes_debugging
class Test_DateValueObject(unittest.TestCase, TestObjectHelper):
    """
    ...
    """
    def setUp(self):
        if _debug: Test_DateValueObject._debug("Test_DateValueObject")
        self.obj = DateValueObject()
        self.objType = 'dateValue'
