...
"""
Nose Test Objects IntegerValueObject
---------------------
"""
...
from bacpypes.object import IntegerValueObject, WritableProperty, ReadableProperty, OptionalProperty, EventLogRecord
...
@bacpypes_debugging
class Test_IntegerValueObject(unittest.TestCase, TestObjectHelper):
    """
    ...
    """
    def setUp(self):
        if _debug: Test_IntegerValueObject._debug("Test_IntegerValueObject")
        self.obj = IntegerValueObject()
        self.objType = 'integerValue'
