...
"""
Nose Test Objects AnalogInputObject
---------------------
"""
...
from bacpypes.object import AnalogInputObject, WritableProperty, ReadableProperty, OptionalProperty
...
@bacpypes_debugging
class Test_AnalogInputObject(unittest.TestCase, TestObjectHelper):
    """
    ...
    """
    def setUp(self):
        if _debug: Test_AnalogInputObject._debug("Test_AnalogInputObject")
        self.obj = AnalogInputObject()
        self.objType = 'analogInput'
