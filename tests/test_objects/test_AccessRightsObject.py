...
from bacpypes.object import AccessRightsObject, WritableProperty, ReadableProperty, OptionalProperty
...
@bacpypes_debugging
class Test_AccessRightsObject(unittest.TestCase, TestObjectHelper):
    """
