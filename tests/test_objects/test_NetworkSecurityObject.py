...
"""
Nose Test Objects NetworkSecurityObject
---------------------
"""
...
from bacpypes.object import NetworkSecurityObject, WritableProperty, ReadableProperty, OptionalProperty, EventLogRecord
...
@bacpypes_debugging
class Test_NetworkSecurityObject(unittest.TestCase, TestObjectHelper):
    """
    ...
    """
    def setUp(self):
        if _debug: Test_NetworkSecurityObject._debug("Test_NetworkSecurityObject")
        self.obj = NetworkSecurityObject()
        self.objType = 'networkSecurity'
        self.identifiers = self.build_list_of_identifiers(self.obj.properties)
        self.numberOfPropertiesRequired = 11
        self.writeValue = 0
