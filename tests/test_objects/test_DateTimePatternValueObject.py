...
"""
Nose Test Objects DateTimePatternValueObject
---------------------
"""
...
from bacpypes.object import DateTimePatternValueObject, WritableProperty, ReadableProperty, OptionalProperty
...
@bacpypes_debugging
class Test_DateTimePatternValueObject(unittest.TestCase, TestObjectHelper):
    """
    ...
    """
    def setUp(self):
        if _debug: Test_DateTimePatternValueObject._debug("Test_DateTimePatternValueObject")
        self.obj = DateTimePatternValueObject()
        self.objType = 'datetimePatternValue'
