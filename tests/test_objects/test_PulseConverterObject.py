...
"""
Nose Test Objects PulseConverterObject
---------------------
"""
...
from bacpypes.object import PulseConverterObject, WritableProperty, ReadableProperty, OptionalProperty, EventLogRecord
...
@bacpypes_debugging
class Test_PulseConverterObject(unittest.TestCase, TestObjectHelper):
    """
    ...
    """
    def setUp(self):
        if _debug: Test_PulseConverterObject._debug("Test_PulseConverterObject")
        self.obj = PulseConverterObject()
        self.objType = 'pulseConverter'
