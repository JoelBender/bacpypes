...
"""
Nose Test Objects CharacterStringValueObject
---------------------
"""
...
from bacpypes.object import CharacterStringValueObject, WritableProperty, ReadableProperty, OptionalProperty
...
@bacpypes_debugging
class Test_CharacterStringValueObject(unittest.TestCase, TestObjectHelper):
    """
    ...
    """
    def setUp(self):
        if _debug: Test_CharacterStringValueObject._debug("Test_CharacterStringValueObject")
        self.obj = CharacterStringValueObject()
        self.objType = 'characterstringValue'
        self.identifiers = self.build_list_of_identifiers(self.obj.properties)
        self.numberOfPropertiesRequired = 22
        self.writeValue = 0
