...
"""
Nose Test Objects LifeSafetyZoneObject
---------------------
"""
...
from bacpypes.object import LifeSafetyZoneObject, WritableProperty, ReadableProperty, OptionalProperty, EventLogRecord
...
@bacpypes_debugging
class Test_LifeSafetyZoneObject(unittest.TestCase, TestObjectHelper):
    """
    ...
    """
    def setUp(self):
        if _debug: Test_LifeSafetyZoneObject._debug("Test_LifeSafetyZoneObject")
        self.obj = LifeSafetyZoneObject()
        self.objType = 'lifeSafetyZone'
