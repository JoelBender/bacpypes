...
"""
Nose Test Objects MultiStateInputObject
---------------------
"""
...
from bacpypes.object import MultiStateInputObject, WritableProperty, ReadableProperty, OptionalProperty, EventLogRecord
...
@bacpypes_debugging
class Test_MultiStateInputObject(unittest.TestCase, TestObjectHelper):
    """
    ...
    """
    def setUp(self):
        if _debug: Test_MultiStateInputObject._debug("Test_MultiStateInputObject")
        self.obj = MultiStateInputObject()
        self.objType = 'multiStateInput'
