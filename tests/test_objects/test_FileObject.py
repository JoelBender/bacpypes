...
from bacpypes.object import FileObject, WritableProperty, ReadableProperty, OptionalProperty, EventLogRecord
...
@bacpypes_debugging
class Test_FileObject(unittest.TestCase, TestObjectHelper):
    """
    ...
    """
    def setUp(self):
        if _debug: Test_FileObject._debug("Test_FileObject")
        self.obj = FileObject()
        self.objType = 'file'
