...
"""
Nose Test Objects NotificationClassObject
---------------------
"""
...
from bacpypes.object import NotificationClassObject, WritableProperty, ReadableProperty, OptionalProperty, EventLogRecord
...
@bacpypes_debugging
class Test_NotificationClassObject(unittest.TestCase, TestObjectHelper):
    """
    ...
    """
    def setUp(self):
        if _debug: Test_NotificationClassObject._debug("Test_NotificationClassObject")
        self.obj = NotificationClassObject()
        self.objType = 'notificationClass'
