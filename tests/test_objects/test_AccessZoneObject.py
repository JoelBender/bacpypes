...
"""
Nose Test Objects AccessPointObject
---------------------
"""
...
from bacpypes.object import AccessZoneObject, WritableProperty, ReadableProperty, OptionalProperty
...
@bacpypes_debugging
class Test_AccessZoneObject(unittest.TestCase, TestObjectHelper):
    """
    ...
    """
    def setUp(self):
        if _debug: Test_AccessZoneObject._debug("Test_AccessZoneObject")
        self.obj = AccessZoneObject()
        self.objType = 'accessZone'
        self.identifiers = self.build_list_of_identifiers(self.obj.properties)
        self.numberOfPropertiesRequired = 34
        self.writeValue = 0
