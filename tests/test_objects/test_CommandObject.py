...
"""
Nose Test Objects CommandObject
---------------------
"""
...
from bacpypes.object import CommandObject, WritableProperty, ReadableProperty, OptionalProperty
...
@bacpypes_debugging
class Test_CommandObject(unittest.TestCase, TestObjectHelper):
    """
    ...
    """
    def setUp(self):
        if _debug: Test_CommandObject._debug("Test_CommandObject")
        self.obj = CommandObject()
        self.objType = 'command'
        self.identifiers = self.build_list_of_identifiers(self.obj.properties)
        self.numberOfPropertiesRequired = 5
        self.writeValue = 0
