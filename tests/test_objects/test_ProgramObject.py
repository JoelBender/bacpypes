...
"""
Nose Test Objects ProgramObject
---------------------
"""
...
from bacpypes.object import ProgramObject, WritableProperty, ReadableProperty, OptionalProperty, EventLogRecord
...
@bacpypes_debugging
class Test_ProgramObject(unittest.TestCase, TestObjectHelper):
    """
    ...
    """
    def setUp(self):
        if _debug: Test_ProgramObject._debug("Test_ProgramObject")
        self.obj = ProgramObject()
