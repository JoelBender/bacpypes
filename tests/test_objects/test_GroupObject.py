...
from bacpypes.object import GroupObject, WritableProperty, ReadableProperty, OptionalProperty, EventLogRecord
...
@bacpypes_debugging
class Test_GroupObject(unittest.TestCase, TestObjectHelper):
    """
    ...
    """
    def setUp(self):
        if _debug: Test_GroupObject._debug("Test_GroupObject")
        self.obj = GroupObject()
        self.objType = 'group'
