...
"""
This application presents a 'console' prompt to the user asking for read
commands which create ReadPropertyRequest PDUs, then lines up the
coorresponding ReadPropertyACK and prints the value.

This version uses the --json option for settings, BACpypes.json rather than
BACpypes.ini.
"""
...
from bacpypes.consolelogging import JSONArgumentParser, ConsoleLogHandler
